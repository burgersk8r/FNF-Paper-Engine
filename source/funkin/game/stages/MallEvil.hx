...
class MallEvil extends BaseStage
{
	...
	{
		var bg:BGSprite = new BGSprite('stages/week5/christmas/evilBG', -400, -500, 0.2, 0.2);
		bg.setGraphicSize(Std.int(bg.width * 0.8));
		bg.updateHitbox();
		add(bg);

		var evilTree:BGSprite = new BGSprite('stages/week5/christmas/evilTree', 300, -300, 0.2, 0.2);
		add(evilTree);

		var evilSnow:BGSprite = new BGSprite('stages/week5/christmas/evilSnow', -200, 700);
		add(evilSnow);
