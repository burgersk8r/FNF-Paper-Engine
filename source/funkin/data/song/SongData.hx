...
class SongChartData implements ICloneable<SongChartData>
{
  ...
  public function new(scrollSpeed:Map<String, Float>, events:Array<Null>, notes:Map<String, Array<SongNoteData>>)
  {
    this.version = SongRegistry.SONG_CHART_DATA_VERSION;
  ...
  public function clone():SongChartData
  {
    ...
    var eventDataClone:Array<Null> = this.events.deepClone();
