...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var ui_tex = Paths.getSparrowAtlas('game/menus/storymenu/assets');
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 425).loadGraphic(Paths.image('game/menus/storymenu/tracks'));
		add(tracksSprite);
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		var newImage:FlxGraphic = Paths.image('game/menus/storymenu/difficulties/' + Paths.formatToSongPath(diff));
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if(assetName == null || assetName.length < 1) {
			...
			bgSprite.loadGraphic(Paths.image('game/menus/storymenu/bgs/menu_' + assetName));
		}
